...
namespace Communications.UWP.Core.MsgPumps {
    ...
    public class SocketMsgPump : IMsgPump<SocketMsgPumpConnectData> {
        ...
        public event EventHandler<MsgPumpConnectResults> ConnectResultEvent;
        ...
        public void ConnectAsync(SocketMsgPumpConnectData paramsObj) {
            Task.Run(async () => {
                try {
                    ...
                    this.ConnectResultEvent?.Invoke(this, new MsgPumpConnectResults(true));
                }
                catch (Exception e) {
                    this.log.Exception(9999, "Connect Asyn Error", e);
                    this.ConnectResultEvent?.Invoke(this, new MsgPumpConnectResults(false));
                }
            });
        }
